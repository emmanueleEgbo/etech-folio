...
return(
      ...
      <div className="max-w-lg mx-auto my-8 bg-black rounded-lg shadow-md p-3">
        ...
        <div className="mt-2">
          ...
          <p className="text-white mt-2">A full stack developer with over 3 years of experience in developing web apps.Skilled in JavaScript, TypeScript, React, Node.js, Express.js, Git, etc. </p>
        </div>
